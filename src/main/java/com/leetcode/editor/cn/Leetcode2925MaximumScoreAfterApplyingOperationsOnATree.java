...
public class Leetcode2925MaximumScoreAfterApplyingOperationsOnATree {
    public static void main(String[] args) {
        System.out.println("Leetcode " + 2925);
        Solution solution = new Leetcode2925MaximumScoreAfterApplyingOperationsOnATree().new Solution();
