...
public class Leetcode2246LongestPathWithDifferentAdjacentCharacters {
    //REVIEW @date 2023-11-06 树上dp模板
    public static void main(String[] args) {
        System.out.println("Leetcode " + 2246);
        Solution solution = new Leetcode2246LongestPathWithDifferentAdjacentCharacters().new Solution();
